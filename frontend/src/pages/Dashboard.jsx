...
const Dashboard = () => {
  ...
  const fetchNotes = async () => {
    try {
      const res = await axios.get(`https://note-taking-app-z2ks.onrender.com/api/notes/${userId}`);
      setNotes(res.data);
  ...
  const saveNote = async () => {
    ...
    try {
      if (editNoteId) {
        await axios.put(`https://note-taking-app-z2ks.onrender.com/api/notes/${editNoteId}`, payload);
        toast.success("Note updated");
      } else {
        await axios.post("https://note-taking-app-z2ks.onrender.com/api/notes/create", payload);
  ...
  const deleteNote = async (id) => {
    ...
    try {
      await axios.delete(`https://note-taking-app-z2ks.onrender.com/api/notes/${id}`);
